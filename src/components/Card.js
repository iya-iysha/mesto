export default class Card {
  constructor(data, templateSelector, myId, handleCardClick, handleButtonTrashClick, putLike, deleteLike) {
    ...
    this._buttonTrash = this._cardElement.querySelector('.card__trash-btn');
    this._cardImage = this._cardElement.querySelector('.card__image');
    this._heartCount = this._cardElement.querySelector('.card__heart-count');
    this._buttonLike = this._cardElement.querySelector('.card__heart-btn');
  }
  ...
  _fillTemplate() {
    ...
    if (this._isLiked()) {
      this._buttonLike.classList.add('card__heart-btn_active');
    }
  ...
  updateLikes(data) {
    this._likes = data.likes;
    this._heartCount.textContent = this._likes.length;
    this._buttonLike.classList.toggle('card__heart-btn_active');
  }
